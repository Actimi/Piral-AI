...
exports.commands = exports.apps = void 0;
const apps = __importStar(require("./apps"));
exports.apps = apps;
const helpers_1 = require("./helpers");
function specializeCommand(commands, command, suffix) {
...
function specializeCommands(suffix) {
    const commands = [];
...
const allCommands = [
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('bundler', helpers_1.availableBundlers)
                .describe('bundler', 'Sets the bundler to use.')
                .default('bundler', helpers_1.availableBundlers[0])
                .string('feed')
        ...
        run(args) {
            return apps.debugPiral(args.base, {
                entry: args.source,
                target: args.target,
                port: args.port,
                ...
                hmr: args.hmr,
                krasrc: args.krasrc,
                optimizeModules: args['optimize-modules'],
                publicUrl: args['public-url'],
                bundlerName: args.bundler,
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('type', helpers_1.piralBuildTypeKeys)
        ...
        run(args) {
            return apps.buildPiral(args.base, {
                entry: args.source,
                target: args.target,
                publicUrl: args['public-url'],
                bundlerName: args.bundler,
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('mode', helpers_1.publishModeKeys)
                ...
                .choices('type', helpers_1.piralPublishTypeKeys)
        ...
        run(args) {
            return apps.publishPiral(args.base, {
                source: args.source,
                logLevel: args['log-level'],
                apiKey: args['api-key'],
                cert: args['ca-cert'],
                allowSelfSigned: args['allow-self-signed'],
                url: args.url,
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('framework', helpers_1.frameworkKeys)
                ...
                .choices('language', helpers_1.sourceLanguageKeys)
                ...
                .choices('bundler', helpers_1.bundlerKeys)
        ...
        run(args) {
            return apps.newPiral(args.base, {
                app: args.app,
                target: args.target,
    ...
    },
    {
        ...
        run(args) {
            return apps.upgradePiral(args.base, {
                target: args.target,
    ...
    },
    {
        ...
        run(args) {
            return apps.validatePiral(args.base, {
                entry: args.entry,
                logLevel: args['log-level'],
            });
        },
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('schema', helpers_1.schemaKeys)
        ...
        run(args) {
            return apps.debugPilet(args.base, {
                entry: args.source,
                target: args.target,
                publicUrl: args['public-url'],
                port: args.port,
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .describe('bundler', 'Sets the bundler to use.')
                .default('bundler', helpers_1.availableBundlers[0])
                .choices('type', helpers_1.piletBuildTypeKeys)
        ...
        run(args) {
            return apps.buildPilet(args.base, {
                entry: args.source,
                target: args.target,
                publicUrl: args['public-url'],
                minify: args.minify,
    ...
    },
    {
        ...
        run(args) {
            return apps.packPilet(args.base, {
                source: args.source,
                target: args.target,
                logLevel: args['log-level'],
            });
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .describe('bundler', 'Sets the bundler to use.')
                .default('bundler', helpers_1.availableBundlers[0])
                .choices('from', helpers_1.fromKeys)
        ...
        run(args) {
            return apps.publishPilet(args.base, {
                source: args.source,
                apiKey: args['api-key'],
                url: args.url,
                logLevel: args['log-level'],
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('force-overwrite', helpers_1.forceOverwriteKeys)
                .describe('force-overwrite', 'Determines if files should be overwritten by the command.')
                .default('force-overwrite', (0, helpers_1.keyOfForceOverwrite)(apps.declarationPiletDefaults.forceOverwrite))
                .string('base')
                .default('base', process.cwd())
                .describe('base', 'Sets the base directory. By default the current directory is used.');
        },
        run(args) {
            return apps.declarationPilet(args.base, {
                entry: args.source,
                target: args.target,
                forceOverwrite: (0, helpers_1.valueOfForceOverwrite)(args['force-overwrite']),
                logLevel: args['log-level'],
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                .positional('source', {
                type: 'string',
                describe: 'Sets the source package (potentially incl. its tag/version) containing a Piral instance for templating the scaffold process.',
        ...
        run(args) {
            return apps.newPilet(args.base, {
                target: args.target,
                source: args.source,
                registry: args.registry,
                forceOverwrite: (0, helpers_1.valueOfForceOverwrite)(args['force-overwrite']),
    ...
    },
    {
        ...
        run(args) {
            return apps.upgradePilet(args.base, {
                target: args.target,
                version: args['target-version'],
                logLevel: args['log-level'],
                forceOverwrite: (0, helpers_1.valueOfForceOverwrite)(args['force-overwrite']),
    ...
    },
    {
        ...
        run(args) {
            return apps.validatePilet(args.base, {
                entry: args.entry,
                logLevel: args['log-level'],
                app: args.app,
            });
    ...
    },
    {
        ...
        run(args) {
            return apps.addPiralInstancePilet(args.base, {
                logLevel: args['log-level'],
    ...
    },
    {
        ...
        run(args) {
            return apps.removePiralInstancePilet(args.base, {
                logLevel: args['log-level'],
                app: args.app,
                source: args.source,
                npmClient: args['npm-client'],
    ...
    },
    {
        ...
        run(args) {
            return apps.runEmulatorPiral(args.base, {
                port: args.port,
                strictPort: args['strict-port'],
                app: args.source,
                npmClient: args['npm-client'],
