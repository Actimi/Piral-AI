...
exports.postFile = exports.postForm = exports.handleAxiosError = exports.createAxiosForm = exports.downloadFile = exports.getAgent = exports.getDefaultAgent = exports.getAuthorizationHeaders = exports.getCertificate = exports.getAxiosOptions = void 0;
...
async function postForm(target, scheme, key, formData, customHeaders = {}, httpsAgent, interactive = false) {
    ...
    try {
        ...
        return await handleAxiosError(error, interactive, httpsAgent, (mode, token) => postForm(target, mode, token, formData, customHeaders, httpsAgent, false), (status, statusText, response) => {
            if (status === 500) {
